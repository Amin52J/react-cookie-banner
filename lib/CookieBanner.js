...
var CookieBanner = /** @class */ (function (_super) {
    ...
    function CookieBanner() {
        ...
        _this.onAccept = function () {
            var _a = _this.props, cookies = _a.cookies, cookie = _a.cookie, cookieExpiration = _a.cookieExpiration, path = _a.cookiePath, domain = _a.cookieDomain, onAccept = _a.onAccept;
    ...
    CookieBanner.propTypes = __assign({}, BannerContent_1.propTypes, { children: PropTypes.oneOfType([
        ...
        ]), cookiePath: PropTypes.string, cookieDomain: PropTypes.string, dismissOnScroll: PropTypes.bool, dismissOnScrollThreshold: PropTypes.number });
